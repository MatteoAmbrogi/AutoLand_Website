...
<html lang="it">
    <head>
        ...
        <title>AutoLand - Veicoli Commerciali</title>
    </head>
    <?php
        
        $searchType = VEICOLICOMMERCIALI;
    ...
    ?>
        ...
        <script type="text/javascript">
            ...
            document.getElementById("VeicoliCommerciali").getElementsByTagName("span")[0].className = "highlighted_text";
        </script>
