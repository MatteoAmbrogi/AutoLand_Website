        ...
        <main class="main-content">
            <!-- frecce di navigzione tra le pagine -->
            <div id="navigation" class="navigation">
                <button id="previus" value="" class="previus" onclick="CarLoader.previusPage(<?php echo $searchType ?>)"></button>
                <span id="currentPage" class="currentPage" >1</span>
                <button id="next" value="" class="next" onclick="CarLoader.nextPage(<?php echo $searchType ?>)"></button>
            </div>
            <!-- div contentente tutte le informazioni inserite con ajax -->
            <div id="carDashboard">
        ...
        <footer>
            ...
            <div class="footer">
                <span>Copyright &copy; 2021 by AutoLand, All Rights Reserved.</span>
				<a href="./../html/terms.html" class="footerLink" target="_blank">Terms of Service</a>
			</div>
